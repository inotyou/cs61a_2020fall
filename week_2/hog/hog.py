...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            score = score1
        tmp = score - last_score
        if tmp > running_high:
            print(tmp, "point(s)! The most yet for Player", who)
        else:
            tmp = running_high
        # print("DEBUG:","tmp:", tmp, "running_high", running_high)
        return announce_highest(who, score, tmp)
    return say
    # END PROBLEM 7
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score, opponent_score, 8.7, num_rolls=6)
    # END PROBLEM 12
