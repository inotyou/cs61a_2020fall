...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        i = 0
        while i < self.min_range or nearest_place.bees == []:
            if i > self.max_range or nearest_place == beehive:
                break
            nearest_place = nearest_place.entrance
            i += 1
        if i < self.min_range or i > self.max_range or nearest_place == beehive:
                return None
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.flag == False:
            ...
            while tmp_place:
                if tmp_place.ant:
                    if tmp_place.ant not in QueenAnt.buffed:
                            tmp_place.ant.damage *= 2
                            QueenAnt.buffed.append(tmp_place.ant)
